...
const media = new MediaQueriesService();
...
export default () => {
  $(function () {
    ...
    function initButton() {
      ...
      var buttonWidth = <number>button.width();
      var buttonHeight = <number>button.height();
     ...
     * Add points
     */
    function addPoints(x: any, y: any) {
